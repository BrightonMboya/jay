      ...
      <section>
        <div className="mx-auto w-full max-w-7xl scroll-mt-12 items-center px-8 py-24 md:px-12 lg:px-24">
          ...
          <div className="mx-auto pt-12">
            <div className="mx-auto grid w-full grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-24">
              <div>
                <div className="gap-3 lg:inline-flex lg:items-center">
                  <div className="text-accent-500 flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100">
                    <svg
                      width="15"
                      height="15"
                      viewBox="0 0 15 15"
                  ...
                  <p className="font-display mt-4 text-lg font-semibold leading-6 text-black lg:mt-0">
                    Developer experience
                  </p>
                </div>
                <p className="mt-4 text-sm text-gray-500">
                  Everything I build is keyboard accessible, and I meticulously
                  write the markup to deliver the best screenreader experience.
                </p>
              </div>
              <div>
                <div className="gap-3 lg:inline-flex lg:items-center">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  I tested the template in the latest versions of all browsers
                  to handle lots of edge-cases you might encounter.
                </p>
              </div>
              <div>
                <div className="gap-3 lg:inline-flex lg:items-center">
