        ...
        <div className="relative">
          ...
          <div className="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
            <div className="px-8 lg:px-12">
              <div className="mx-auto max-w-lg lg:mx-0 lg:pr-12">
                <div className="flex flex-wrap">
                  ...
                  <div className="ml-6 flex items-center text-sm font-medium text-black">
                    <svg
                      viewBox="0 0 256 154"
                ...
                <p className="font-display mt-12 text-3xl font-black uppercase tracking-tight text-black">
                  Lexington Themes
                </p>
                <p className="mt-4 max-w-2xl text-base font-medium tracking-tight text-black">
                  Free and premium multipage themes &amp; UI Kits For
                  freelancers, developers, businesses, and personal use.
                  Beautifully crafted with Astro.js, and Tailwind CSS
                  <span className="lg:block">
                    — Simple &amp; easy to customise.
                  </span>
                </p>
                <p className="fon4t-medium font-display border-accent-600 mt-8 text-2xl tracking-tight text-black lg:border-l-4 lg:pl-4">
                  Use the code
                  <span className="text-accent-600"> LEXINGTON30</span>
                  and
                ...
                <p className="mt-8 max-w-2xl text-base font-medium tracking-tight text-black">
                  Get lifetime access to every theme available on Lexington
                  Themes for
                  <span className="text-accent-600">$199</span> and own them
                  forever. Plus, new themes, lifetime updates, use on unlimited
                ...
                <div className="mt-12">
                  <a
                    ...
                    className="bg-accent-600 group inline-flex w-full items-center justify-center gap-4 rounded-xl px-6 py-3 text-sm font-medium text-white outline-offset-2 transition hover:bg-white hover:text-black active:text-gray-900/60 active:transition-none lg:w-auto"
                  >
                    See all templates <span>→</span>
                  </a>
                </div>
              </div>
            </div>
