            ...
            >
              <li>
                <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                  <li>
                    <figure className="relative h-full rounded-3xl bg-white p-6">
                      <blockquote className="relative">
                        <p className="text-base text-gray-500">
                          Snowflake is a cloud data platform that enables data
                          storage, processing, and analytics solutions for
                          businesses and more.
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                        <div>
                          <div className="font-display text-lg font-semibold leading-6 text-black">
                            Annur Flint
                          </div>
                ...
                <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                  ...
                  <li>
                    <figure className="relative h-full rounded-3xl bg-white p-6">
                      <blockquote className="relative">
                        <p className="text-base text-gray-500">
                          Receive bondholders called capitalization investment
                          grade bonds bills management district stocks.
                          Potential funds consulting.
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                        <div>
                ...
                <ul role="list" className="flex flex-col gap-y-6 sm:gap-y-8">
                  <li>
                    <figure className="relative h-full rounded-3xl bg-white p-6">
                      <blockquote className="relative">
                        <p className="text-base text-gray-500">
                          Debt bills lucrative capitalization municipal bonds
                          government 401k bear bull credit corporate bonds
                          called NYSE finance.
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                  ...
                  <li>
                    <figure className="relative h-full rounded-3xl bg-white p-6">
                      <blockquote className="relative">
                        <p className="text-base text-gray-500">
                          Managed prices bondholders federal risk NASDAQ hedge
                          fund expenses municipal bonds management, in the
                          morning.
                        </p>
                      </blockquote>
                      <figcaption className="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
